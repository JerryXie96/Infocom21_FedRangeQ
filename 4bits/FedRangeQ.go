...
var (
	...
	indexSize      int            = 3200                       // the size of index
	batchSize      int            = 25                         // the batch size of one post
	blockSize      int            = 4                          // the number of bits in one block
