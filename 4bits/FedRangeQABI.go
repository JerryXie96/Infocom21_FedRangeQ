...
type Struct0 struct {
	...
	PubKey     [8][]byte
	Tag        [8][15][15]uint8
	Ciphertext [8][15][]byte
}

// FedRangeQABIABI is the input ABI used to generate the binding from.
const FedRangeQABIABI = "[{\"constant\":false,\"inputs\":[],\"name\":\"clearResult\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"components\":[{\"name\":\"pubKey\",\"type\":\"bytes\"},{\"name\":\"tag\",\"type\":\"uint8[8]\"},{\"name\":\"ciphertext\",\"type\":\"bytes[8]\"}],\"name\":\"query\",\"type\":\"tuple\"}],\"name\":\"search\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"getResult\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256[]\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"components\":[{\"name\":\"label\",\"type\":\"uint256\"},{\"name\":\"pubKey\",\"type\":\"bytes[8]\"},{\"name\":\"tag\",\"type\":\"uint8[15][15][8]\"},{\"name\":\"ciphertext\",\"type\":\"bytes[15][8]\"}],\"name\":\"indexToBeAdded\",\"type\":\"tuple[]\"}],\"name\":\"store\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"
...
// Search is a paid mutator transaction binding the contract method 0x8f350df6.
//
// Solidity: function search((bytes,uint8[8],bytes[8]) query) returns()
...
// Store is a paid mutator transaction binding the contract method 0xf66ed5a7.
//
// Solidity: function store((uint256,bytes[8],uint8[15][15][8],bytes[15][8])[] indexToBeAdded) returns()
