...
type Struct0 struct {
	...
	PubKey     [16][]byte
	Tag        [16][3][3]uint8
	Ciphertext [16][3][]byte
}

// FedRangeQABIABI is the input ABI used to generate the binding from.
const FedRangeQABIABI = "[{\"constant\":false,\"inputs\":[{\"components\":[{\"name\":\"pubKey\",\"type\":\"bytes\"},{\"name\":\"tag\",\"type\":\"uint8[16]\"},{\"name\":\"ciphertext\",\"type\":\"bytes[16]\"}],\"name\":\"query\",\"type\":\"tuple\"}],\"name\":\"search\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"components\":[{\"name\":\"label\",\"type\":\"uint256\"},{\"name\":\"pubKey\",\"type\":\"bytes[16]\"},{\"name\":\"tag\",\"type\":\"uint8[3][3][16]\"},{\"name\":\"ciphertext\",\"type\":\"bytes[3][16]\"}],\"name\":\"indexToBeAdded\",\"type\":\"tuple[]\"}],\"name\":\"store\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"clearResult\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"getResult\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256[]\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"
...
// Search is a paid mutator transaction binding the contract method 0x28fcf398.
//
// Solidity: function search((bytes,uint8[16],bytes[16]) query) returns()
func (_FedRangeQABI *FedRangeQABITransactor) Search(opts *bind.TransactOpts, query Struct1) (*types.Transaction, error) {
...
//
// Solidity: function search((bytes,uint8[16],bytes[16]) query) returns()
func (_FedRangeQABI *FedRangeQABISession) Search(query Struct1) (*types.Transaction, error) {
...
//
// Solidity: function search((bytes,uint8[16],bytes[16]) query) returns()
func (_FedRangeQABI *FedRangeQABITransactorSession) Search(query Struct1) (*types.Transaction, error) {
	return _FedRangeQABI.Contract.Search(&_FedRangeQABI.TransactOpts, query)
}

// Store is a paid mutator transaction binding the contract method 0x3ec49113.
//
// Solidity: function store((uint256,bytes[16],uint8[3][3][16],bytes[3][16])[] indexToBeAdded) returns()
func (_FedRangeQABI *FedRangeQABITransactor) Store(opts *bind.TransactOpts, indexToBeAdded []Struct0) (*types.Transaction, error) {
...
//
// Solidity: function store((uint256,bytes[16],uint8[3][3][16],bytes[3][16])[] indexToBeAdded) returns()
func (_FedRangeQABI *FedRangeQABISession) Store(indexToBeAdded []Struct0) (*types.Transaction, error) {
...
//
// Solidity: function store((uint256,bytes[16],uint8[3][3][16],bytes[3][16])[] indexToBeAdded) returns()
func (_FedRangeQABI *FedRangeQABITransactorSession) Store(indexToBeAdded []Struct0) (*types.Transaction, error) {
	return _FedRangeQABI.Contract.Store(&_FedRangeQABI.TransactOpts, indexToBeAdded)
}
