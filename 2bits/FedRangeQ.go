/*
	FedRangeQ.go - 2-bit version (default)
	By Hongcheng Xie at Department of Computer Science, City University of Hong Kong, Hong Kong SAR, China

	This code is the blockchain client in our proposed system, including index encrypting module, index posting module, query encrypting module, query posting module and searching module. In this source code, the block size is set as 2.
...
var (
	...
	indexSize      int            = 100                        // the size of index
